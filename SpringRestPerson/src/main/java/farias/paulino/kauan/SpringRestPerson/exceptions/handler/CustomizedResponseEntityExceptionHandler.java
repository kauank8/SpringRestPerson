package farias.paulino.kauan.SpringRestPerson.exceptions.handler;
...
import farias.paulino.kauan.SpringRestPerson.exceptions.ExceptionResponse;
...
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public final ResponseEntity<ExceptionResponse> handleAllExceptions(Exception ex, WebRequest request){
		ExceptionResponse exceptionReponse = new ExceptionResponse(new Date(),
